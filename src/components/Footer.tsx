      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm mb-4 text-orange-200 max-w-md">
              Gezi Makinesi ile hayalinizdeki tatili planlayın. Turlar, vize danışmanlığı ve 
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>info@gezimakinesi.com</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-orange-900 flex items-center justify-center hover:bg-primary transition-colors"
                >
        ...
        {/* Bottom */}
        <div className="border-t border-orange-900 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-orange-300">
            © {new Date().getFullYear()} Gezi Makinesi. Tüm hakları saklıdır.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-xs text-orange-300">TÜRSAB Belge No: XXXXX</span>
          </div>
        </div>
      </div>
    </footer>
