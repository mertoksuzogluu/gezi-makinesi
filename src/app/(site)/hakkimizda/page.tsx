...
export const metadata: Metadata = {
  title: 'Hakkımızda',
  description: 'Gezi Makinesi hakkında bilgi edinin. 10+ yıllık deneyim, binlerce mutlu müşteri.',
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg opacity-90">
              Gezi Makinesi olarak 10 yılı aşkın süredir seyahat sektöründe hizmet veriyoruz. 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Gezi Makinesi, 2015 yılında seyahat tutkunları tarafından kuruldu. 
                ...
                <p>
                  2020 yılında &quot;Vize Makinesi&quot; alt markamızı oluşturduk. Böylece müşterilerimize 
            ...
            <div className="relative h-[400px] rounded-xl overflow-hidden bg-orange-100">
              <div className="absolute inset-0 flex items-center justify-center">
                <Globe className="h-32 w-32 text-orange-300" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-4">Gezi Makinesi - Turlar</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-4">Vize Makinesi - Vize Danışmanlığı</h3>
                <ul className="space-y-3">
                  {[
                    'Schengen vizesi',
                    'ABD vizesi (B1/B2)',
