...
export const metadata: Metadata = {
  ...
  description: 'Gezi Makinesi ve Vize Makinesi hakkında sıkça sorulan sorular ve cevapları.',
};

const generalFaqs = [
  {
    question: 'Gezi Makinesi nedir?',
    answer: 'Gezi Makinesi, tur organizasyonları ve vize danışmanlığı hizmetleri sunan bir seyahat acentesidir. 10 yılı aşkın deneyimimizle müşterilerimize kaliteli hizmet sunuyoruz.'
  },
  {
...
const visaFaqs = [
  ...
  {
    question: 'Vize danışmanlığı ücretiniz ne kadardır?',
    answer: 'Vize danışmanlığı ücretimiz ülkeye göre değişmektedir. Her ülke sayfasında güncel hizmet bedelimizi görebilirsiniz. Bu ücret, evrak kontrolü, form doldurma ve randevu desteğini kapsar.'
  },
  {
