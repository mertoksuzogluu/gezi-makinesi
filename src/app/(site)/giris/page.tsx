...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        const authData = localStorage.getItem('gezi_makinesi_auth');
        if (authData) {
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-muted-foreground text-center mb-2">Demo hesapları:</p>
              <div className="space-y-2 text-sm text-center">
                <div>
                  <p className="font-semibold mb-1">Kullanıcı:</p>
                ...
                <div className="pt-2 border-t">
                  ...
                  <span className="font-mono">admin@vizelyio.com</span>
                  <br />
