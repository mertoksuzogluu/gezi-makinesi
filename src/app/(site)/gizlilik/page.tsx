...
export const metadata: Metadata = {
  ...
  description: 'Vizelyio gizlilik politikası ve KVKK aydınlatma metni.',
};
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto prose prose-orange">
        ...
        <h2>1. Giriş</h2>
        <p>
          Vizelyio olarak kişisel verilerinizin güvenliği konusunda azami hassasiyet göstermekteyiz. 
