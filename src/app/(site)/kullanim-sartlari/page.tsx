...
export const metadata: Metadata = {
  ...
  description: 'Gezi Makinesi kullanım şartları ve koşulları.',
};
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto prose prose-orange">
        ...
        <p>
          ...
          Gezi Makinesi, bu şartları önceden haber vermeksizin değiştirme hakkını saklı tutar.
        </p>

        <h2>2. Hizmet Tanımı</h2>
        <p>
          Gezi Makinesi, tur organizasyonu ve vize danışmanlığı hizmetleri sunan bir seyahat acentesidir. 
          Sunulan hizmetler:
        </p>
        <ul>
        ...
        <ul>
          ...
          <li>Vize danışmanlığı: Hizmet bedeli peşin</li>
        </ul>
        ...
        <p>
          Vize danışmanlığı hizmet bedeli, hizmet başladıktan sonra iade edilmez. 
          Vize ret durumlarında konsolosluk ücretleri iade edilmez.
        </p>

        <h2>5. Sorumluluk Sınırları</h2>
        <p>Gezi Makinesi aşağıdaki durumlarda sorumluluk kabul etmez:</p>
        <ul>
        ...
        <p>
          Web sitesindeki tüm içerik (metin, görsel, logo vb.) Gezi Makinesi&apos;ne aittir. 
